"""Rename TNG relation to SDL

Revision ID: 4f3a7a5c7701
Revises: 007d476ebeec
Create Date: 2019-06-26 14:16:24.005445
...
revision = '4f3a7a5c7701'
down_revision = '007d476ebeec'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('rel_brk_tng_brk_sdl_is_gebaseerd_op_stukdeel',
    ...
    op.add_column('brk_tenaamstellingen', sa.Column('is_gebaseerd_op_stukdeel', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True))
...
def downgrade():
    ...
    op.drop_column('brk_tenaamstellingen', 'is_gebaseerd_op_stukdeel')
    ...
    sa.PrimaryKeyConstraint('_gobid', name='rel_brk_tng_brk_sdl_gebaseerd_op_stukdeel_pkey')
    )
    op.drop_table('rel_brk_tng_brk_sdl_is_gebaseerd_op_stukdeel')
    # ### end Alembic commands ###
