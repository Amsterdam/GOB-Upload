...
Revision ID: a1c52c65451b
Revises: 19f159c5e167
Create Date: 2023-07-19 11:40:43.771323
...
def upgrade():
    ...
    op.create_table('brk2_erfpachtcanons',
    ...
    sa.Column('jaarlijks_bedrag', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    ...
    sa.Column('betreft_brk_zakelijkrecht', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    ...
    sa.UniqueConstraint('_id', 'volgnummer', name='brk2_erfpachtcanons__id_volgnummer_key'),
    sa.UniqueConstraint('_tid', name='brk2_erfpachtcanons__tid_key')
    )
    op.create_table('qa_brk2_erfpachtcanons',
    ...
    op.create_table('rel_brk2_ecs_brk2_sdl_is_gebaseerd_op_brk_stukdeel',
    ...
    sa.Column('_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('_tid', sa.String(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['dst_id'], ['brk2_stukdelen._id'], name='rel_brk2_ecs_brk2_sdl_is_gebaseerd_op_brk_stukdeel_dfk'),
    sa.ForeignKeyConstraint(['src_id', 'src_volgnummer'], ['brk2_erfpachtcanons._id', 'brk2_erfpachtcanons.volgnummer'], name='rel_brk2_ecs_brk2_sdl_is_gebaseerd_op_brk_stukdeel_sfk'),
    sa.PrimaryKeyConstraint('_gobid'),
    ...
    op.create_table('rel_brk2_ecs_brk2_zrt_betreft_brk_zakelijkrecht',
    sa.Column('id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('src_source', sa.String(), autoincrement=False, nullable=True),
    sa.Column('src_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('src_volgnummer', sa.Integer(), autoincrement=False, nullable=True),
    ...
    sa.Column('_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('_tid', sa.String(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['dst_id', 'dst_volgnummer'], ['brk2_zakelijkerechten._id', 'brk2_zakelijkerechten.volgnummer'], name='rel_brk2_ecs_brk2_zrt_betreft_brk_zakelijkrecht_dfk'),
    sa.ForeignKeyConstraint(['src_id', 'src_volgnummer'], ['brk2_erfpachtcanons._id', 'brk2_erfpachtcanons.volgnummer'], name='rel_brk2_ecs_brk2_zrt_betreft_brk_zakelijkrecht_sfk'),
    sa.PrimaryKeyConstraint('_gobid'),
    sa.UniqueConstraint('_source_id', name='rel_brk2_ecs_brk2_zrt_betreft_brk_zakelijkrecht_uniq'),
    sa.UniqueConstraint('_tid', name='rel_brk2_ecs_brk2_zrt_betreft_brk_zakelijkrecht__tid_key')
    )
    op.create_table('rel_brk2_sdl_brk2_ecs_is_bron_voor_brk_erfpachtcanon',
    sa.Column('id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('src_source', sa.String(), autoincrement=False, nullable=True),
    sa.Column('src_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('src_volgnummer', sa.Integer(), autoincrement=False, nullable=True),
    ...
    sa.Column('_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('_tid', sa.String(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['dst_id', 'dst_volgnummer'], ['brk2_erfpachtcanons._id', 'brk2_erfpachtcanons.volgnummer'], name='rel_brk2_sdl_brk2_ecs_is_bron_voor_brk_erfpachtcanon_dfk'),
    sa.ForeignKeyConstraint(['src_id'], ['brk2_stukdelen._id'], name='rel_brk2_sdl_brk2_ecs_is_bron_voor_brk_erfpachtcanon_sfk'),
    sa.PrimaryKeyConstraint('_gobid'),
...
def downgrade():
    ...
    op.drop_table('rel_brk2_ecs_brk2_zrt_betreft_brk_zakelijkrecht')
