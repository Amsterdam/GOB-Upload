...
def upgrade():
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_art_brk2_tng_betrokken_brk_tenaamstelling CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_sdl_brk2_tng_is_bron_voor_brk_tenaamstelling CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_tng_brk2_sdl_is_gebaseerd_op_brk_stukdelen CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_tng_brk2_sjt__betr_gorzen_aanwassen_brk_sjt_ CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_tng_brk2_sjt__betr_samenwerkverband_brk_sjt_ CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_tng_brk2_sjt_betrokken_partner_brk_subject CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_tng_brk2_sjt_van_brk_kadastraalsubject CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_tng_brk2_zrt_van_brk_zakelijk_recht CASCADE")
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS mv_brk2_zrt_brk2_tng__is_beperkt_tot_brk_tng_ CASCADE")
