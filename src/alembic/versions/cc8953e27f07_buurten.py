...
Revision ID: cc8953e27f07
Revises: fc690dd4ed41
Create Date: 2018-11-27 11:14:49.745646
...
revision = 'cc8953e27f07'
down_revision = 'fc690dd4ed41'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('gebieden_buurten',
    ...
    sa.Column('ligt_in_wijk', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('gebieden_buurten')
    # ### end Alembic commands ###
