...
Revision ID: 5641f7061aaa
Revises: cc8953e27f07
Create Date: 2018-11-27 13:13:01.543441
...
revision = '5641f7061aaa'
down_revision = 'cc8953e27f07'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('gebieden_stadsdelen',
    ...
    op.create_table('gebieden_wijken',
    sa.Column('_gobid', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('_id', sa.String(), autoincrement=False, nullable=True),
    sa.Column('_source', sa.String(), autoincrement=False, nullable=True),
    sa.Column('_source_id', sa.String(), autoincrement=False, nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('gebieden_wijken')
    op.drop_table('gebieden_stadsdelen')
    # ### end Alembic commands ###
