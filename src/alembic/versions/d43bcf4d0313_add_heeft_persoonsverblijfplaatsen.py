...
drop_idx = """
create or replace function remove_indexes_brp() returns void as $$
declare
    indices CURSOR FOR
	select
		indexname
...
def upgrade():
    ...
    # Drop indices first, to fix upgrade. They are regenerated later
    # Error msg:
    # Storage migration failed: (psycopg2.errors.UndefinedObject)
