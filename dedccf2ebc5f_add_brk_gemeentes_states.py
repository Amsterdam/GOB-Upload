...
def upgrade():
    ...
    op.add_column('brk_gemeentes', sa.Column('volgnummer', sa.Integer(), autoincrement=False, nullable=True))
    op.add_column('brk_gemeentes', sa.Column('registratiedatum', sa.DateTime(), autoincrement=False, nullable=True))
    ...
    op.execute('DROP MATERIALIZED VIEW IF EXISTS mv_gbd_sdl_brk_gme_ligt_in_gemeente')
    op.execute('DROP MATERIALIZED VIEW IF EXISTS mv_brk_kot_brk_gme__angdd_dr__gemeente')
    op.execute('DROP MATERIALIZED VIEW IF EXISTS mv_gbd_sdl_brk_gme_ligt_in_gemeente')
